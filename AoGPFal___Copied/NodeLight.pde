class NodeLight extends NodeBase {
  ...
  void         setDirectionAcceleration(PVector iValue)          { mDirection.setAccelerationn( iValue ); }
 
  void setLookAt(PVector iEye, PVector iTarget) {
    // This method will st a spotlight position and direction in a simiarl manner to 
  ...
  void goToState(String iStateName, float iDuration) { 
    ...
    mSpecualrColor.goToState( iStateName, iDuration ); 
  ...
  void addStateSpecularColroAcceleration(String iStateName, PVector iValue) { mColor.addState( iStateName, iValue ); }
  ...
  void createDirectional(int iRed, int iGreen, int iBlue, PVector iDrection) {
    mColor.set(new Pvector( iRed, iGreen, iBlue ) ); 
 ...
 void createSpotlightState(String iStateName, int iRed, int iGreen, int iBlue, PVector iPosition, PVector iDirection, float iAngle, float iConcentration){
   ...
   addStatePosition( iStateName, iPosition ); 
   addStateDirection( iStateName, iDirection ); 
   addStateSpotAngle( iStateName, iDirection ); 
